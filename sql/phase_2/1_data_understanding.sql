-- 2.1 – Data understanding (TABLE BY TABLE)

-- 2.1.1 SILVER.FINANCIAL_TRANSACTIONS_CLEAN (Sales)
...
-- 2.1.4 SILVER.CUSTOMER_DEMOGRAPHICS_CLEAN (Customers)
...
-- 2.1.5 SILVER.PRODUCT_REVIEWS_CLEAN (Reviews)
...
-- 2.1.6 SILVER.CUSTOMER_SERVICE_INTERACTIONS_CLEAN (Customer service)
...
-- 2.1.7 SILVER.LOGISTICS_AND_SHIPPING_CLEAN (Logistics)
...
-- 2.1.8 SILVER.INVENTORY_CLEAN (Inventory)
